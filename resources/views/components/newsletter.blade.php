<div class="bg-primary py-16 sm:py-24 lg:py-28">
        ...
        <form class="w-full max-w-md lg:col-span-5 lg:pt-2">
            <div class="flex gap-x-4">
                ...
                <input id="email-address" name="email" type="email" autocomplete="email" required
                    ...
                    <a href="#"
                    class="text-primary hidden lg:flex bg-white hover:bg-white focus:ring-4 focus:ring-white font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2  focus:outline-none">Subscribe</a>
            </div>
            <p class="mt-4 text-sm leading-6 text-gray-300">We care about your data. Read our <a href="#"
                    class="font-semibold text-white hover:text-indigo-50">privacy&nbsp;policy</a>.</p>
        </form>
    </div>
</div>