    ...
    <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div class="max-w-md w-full p-6">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <button type="submit"
                        class="w-full bg-primary text-white p-2 rounded-md hover:bg-primary focus:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Log In
                    </button>
                </div>
            </form>
            <div class="mt-4 text-sm text-gray-600 text-center">
                <p>Already have an account? <a href="#" class="text-black hover:underline">Sign In</a>
                </p>
            </div>
        </div>
    </div>
